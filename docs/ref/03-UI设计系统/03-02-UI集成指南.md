---
source: Echoes_of_Yesterday_UI_v1.1/GAME_INTEGRATION_GUIDE.md
date: 2026-07-30
status: archived-reference
related: 03-01-UI设计系统v1.1.md, 03-04-UI使用指南.md
---

# 03-02 UI 集成指南

> 原始文档：《昨日重现》游戏 UI 接入指南  
> 说明：规定剧情和关卡代码如何与 UI 系统交互

---

## 基本原则

剧情和关卡代码不得修改正式 UI 的 HTML、CSS、图片或 DOM。所有页面切换均通过 `src/ui/UIManager.js`；章节美术、清晰度与按钮坐标由 `src/ui/memory-report-config.json` 管理。
