---
source: Echoes_of_Yesterday_UI_v1.1/UI_CHANGELOG.md
date: 2026-07-30
status: archived-reference
related: 03-05-UI基线冻结.md, 03-03-UI资产清单.md
---
...
后续任何视觉变化必须新增版本条目（v1.1、v1.2...），不得覆盖本条记录。纯剧情数据扩展可以保持 UI v1.0，但仍需记录关联配置和回归结果。
